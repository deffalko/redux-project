Проект на React при промощи Redux на начальном этапе. В проекте реализован функционал добавлений, удаления и фильтрация элементов. Визуал взял с Frontend Mentors.
